...
THREEx.DayNight.StarField = function () {
  ...
  var texture = THREE.ImageUtils.loadTexture(
    THREEx.DayNight.baseURL + "images/galaxy_starfield.png"
  );
  ...
  this.update = function (sunAngle) {
    ...
    if (phase === "day") {
      ...
      var intensity = Math.abs(Math.sin(sunAngle) - 0.6);
...
THREEx.DayNight.Skydom = function () {
  ...
  this.update = function (sunAngle) {
    ...
    if (phase === "day") {
      ...
      //uniforms.topColor.value.set("rgba(0,0,0,0)");
      //uniforms.bottomColor.value.set("rgba(0,0,0,0)");
    }
  };
};
