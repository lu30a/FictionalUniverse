...
THREEx.Terrain.allocateHeightMap.ArrayClass =
  window.Float64Array || window.Array;
...
THREEx.Terrain.planeToHeightMapCoords = function (heightMap, planeMesh, x, z) {
  ...
  position.y = THREEx.Terrain.heightMapToHeight(
    heightMap,
    position.x,
    position.z
  );
...
THREEx.Terrain.planeToHeightMapCoords0 = function (
  position,
  heightMap,
  planeMesh
) {
  ...
  var height = THREEx.Terrain.heightMapToHeight(
    heightMap,
    position.x,
    position.z
  );
...
THREEx.Terrain.heightToColor = (function () {
  ...
  return function (height) {
    ...
    if (height < 0.3) {
      ...
      color.setRGB(0.9, 0.8, 0.2);
    } else if (height < 0.5) {
      //height = (height - 0.5) / 0.2;
      //height = height * 0.5 + 0.2;
      color.setRGB(0.6, height, 0.1);
    } else if (height < 0.7) {
      //height = (height - 0.5) / 0.2;
      //height = height * 0.5 + 0.2;
      color.setRGB(0, height * 0.8, 0);
    } else {
      //height = (height - 0.7) / 0.3;
      //height = height * 0.5 + 0.5;
      color.setRGB(height * 0.3, height * 0.3, height * 0.3);
    }
    color.setRGB(128 / 255, 116 / 255, 76 / 255);
    return color;
  };
})();
 ...
 */
THREEx.Terrain.PlaneGeometry = function (
  width,
  height,
  widthSegments,
  heightSegments
...
THREEx.Terrain.PlaneGeometry.prototype = Object.create(
